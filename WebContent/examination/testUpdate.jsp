	                    ...
	                    <div class="blog-details-text">
					   	<div class="classynav"  >
	                    	...
	                    	<form action="updateTest" method="post" name="frm" id="frm" onsubmit="return inputCheck()">
		                        <p>Exam Number : <input type="text" name="test_no" value="${exam.test_no}"></p>
		                        <p>Last Number : ${count} </p>
		                        <p>Exam Content <br> <textarea rows="8" cols="70" name="content">${exam.content}</textarea>
		                        <p>Answer : <input type="text" name="answer" value="${exam.answer}"></p>
		                        <p>Subject 
		                        	<select name="subject_no" id ="subject_no">
									<option value="">선택 
									<c:forEach items="${subjectlist}" var="subject">
										<option value="${subject.subject_no}" 
											<c:if test="${subject.subject_no==exam.subject_no}"> selected="selected"</c:if> 
										>${subject.subject_no}_${subject.subject_name}
									</c:forEach>	
									</select>
								</p>
								<p>
